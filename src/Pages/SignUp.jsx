      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
        ...
        <div className="md:w-[67%] lg:w-[40%] lg:ml-20">
          <form action="" className='flex flex-col space-y-4' onSubmit={onSubmit}>
            ...
            <button type="submit" className='w-full px-7 py-3 bg-blue-600 text-white text-sm uppercase hover:bg-blue-700 rounded shadow-md font-medium transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800'>Sign Up</button>
