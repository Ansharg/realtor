      ...
      <div className=' m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5'>
        <div className=' w-full'>
          ...
          {listing.userRef !== auth.currentUser?.uid && !contactLandLord && (
            <div className='mt-6'>
              <button className='px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:shadow-lg focus:bg-blue-700 w-full text-center transition ease-in-out duration-150' onClick={()=>setContactLandLord(true)}>Contact Landlord</button>
            </div>
          )}
          {contactLandLord && (
        ...
        <div className=' w-full z-10 h-[200px] md:h-[400px] md:mt-0 md:ml-2 overflow-x-hidden mt-6'>
